...
class ItemList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> deleteTodo() async {
      await firestore.collection('Todos').doc(transaksiDocId).delete();
    }

    Future<void> updateTodo() async {
      await firestore.collection('Todos').doc(transaksiDocId).update({
              ...
              children: [
                TextField(
                  controller:
                      ...
                      todo.title == null ? titleController : titleController
                        ..text = todo.title,
